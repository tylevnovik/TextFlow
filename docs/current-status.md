...
本文档描述截至 `2026-05-14` 的仓库事实，用来回答“现在项目做到哪一步了”。
...
| workflow 画布 | 可用，正在工作台化 | 当前已经是主流程入口，支持节点、连线、视口恢复、工具箱、mini-map 和节点内配置；画布节点/连线选择已同步右侧 `WorkflowInspector`，语料集合和词库资源表可从对象树拖入画布触发绑定入口。 |
