...
| --- | --- | --- | --- |
| 示例 01 - WoS论文关键词与主题流程 | `wos` | WoS 字段映射、主文本拼接、元数据标准化、去重、清洗、切词、词表、特征词、关键词、主题、年份趋势、共现、导出 | 工作流节点上的产物按钮 |
| 示例 02 - IncoPat专利技术识别与图分析 | `incopat` | 专利元数据标准化、claims 文本、共现网络、图指标、社区、主路径、链接预测、技术指标和技术分类 | 技术指标、图分析和 HTML 报告产物 |
| 示例 03 - 论文专利融合分析流程 | `wos + incopat` | 多来源合并、source profile 保留、机构关键词/主题、跨来源统计、图谱与技术输出 | 多来源节点和导出节点产物 |
