...
def _port(port_id: str, port_type: str, label: str, *, allow_multiple: bool = False) -> dict[str, Any]:
    payload = {
        "port_id": port_id,
        "port_type": port_type,
        "label": label,
...
def builtin_node_definitions(pipeline: dict[str, Any] | None = None) -> list[dict[str, Any]]:
    ...
    return [
        ...
        },
        {
            ...
            "outputs": [_port("frequency_table", "FrequencyTable", "词频表")],
            "params": [_number_param("top_n", "Top N", int(analysis.get("top_n", 200)))],
            "runtime": _runtime("analysis", "analysis.frequency_statistics", cacheable=True, previewable=True),
        },
        {
            ...
            "inputs": [_port("token_corpus_in", "FilteredTokenCorpus", "分析词项")],
            "outputs": [_port("term_year_table", "TermYearTable", "词项年份表")],
            "params": [],
            "runtime": _runtime("analysis", "analysis.term_year", cacheable=True, previewable=True),
        },
        {
            ...
            "inputs": [_port("token_corpus_in", "FilteredTokenCorpus", "分析词项")],
            "outputs": [_port("cooccurrence_table", "CooccurrenceTable", "共现表")],
            "params": [
            ...
            "runtime": _runtime("analysis", "analysis.cooccurrence", cacheable=True, previewable=True),
        },
        {
            ...
            "inputs": [_port("token_corpus_in", "FilteredTokenCorpus", "分析词项")],
            "outputs": [_port("keyword_table", "KeywordTable", "关键词表")],
            "params": [
            ...
            "runtime": _runtime("analysis", "analysis.keyword_extraction", cacheable=True, previewable=True),
        },
        {
            ...
            "outputs": [_port("keyword_cluster_table", "KeywordClusterTable", "关键词聚类表")],
            "params": [
            ...
            "runtime": _runtime("analysis", "analysis.keyword_clustering", cacheable=True, previewable=True),
        },
        {
            ...
            "inputs": [_port("token_corpus_in", "FilteredTokenCorpus", "分析词项")],
            "outputs": [_port("institution_topic_table", "InstitutionTopicTable", "机构主题表")],
            "params": [
                _number_param("topic_model_k", "主题数量", int(analysis.get("topic_model_k", 4))),
            ],
            "runtime": _runtime("analysis", "analysis.institution_topic", cacheable=True, previewable=True),
        },
        {
            "type": "save_csv",
            "title": "保存 CSV",
