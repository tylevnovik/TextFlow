...
from ._common import enum_param, string_param, port, runtime, node_definition_from_base, analysis_passthrough_compiler, field, graph, slot, ui
...
def node_definition(runtime_profile: dict[str, Any] | None = None) -> dict[str, Any]:
    base = {
        ...
        "graph": graph((320, 220), (1920, 1320), toolbox_order=280),
        "ui": ui(
            [
                field("text", "field", "时间字段"),
                field("select", "granularity", "分桶粒度"),
            ],
        ),
    }
